...
List<Petsfood> view_food = [
  ...
  Petsfood(
      ...
      Rate: "4.5"),
  Petsfood(
      image: "asset/Pets_Food/petsfood7.png",
      name: "Whiskas Adult (+1 year) Dry Cat Food, Mackerel Flavour",
      size: "",
      Prise: "₹425",
      Rate: "3.7"),
  Petsfood(
      image: "asset/Pets_Food/petsfood8.jpg",
      name: "Chappi Adult Dry Dog Food, Chicken & Rice,",
      size: "",
      Prise: "₹454",
      Rate: "4.3"),
  Petsfood(
      image: "asset/Pets_Food/petsfood9.jpg",
      name: "Drools Maintenance Adult Dry Dog Food, Chicken Flavour",
      size: "",
      Prise: "₹2,772 ",
      Rate: "4.1"),
  Petsfood(
      image: "asset/Pets_Food/petsfood10.jpg",
      name: "Maxi Adult Dog Food, Chicken and Liver",
      size: "",
      Prise: "₹2,465",
      Rate: "4.2"),
];
