...
import 'package:only_pets/model/cityModel.dart';
...
class AddAddressController extends GetxController {
  ...
  late FocusNode deliverynamenode,
      ...
      userNameNode,
      emailIdNode;
  var deliveryNameModel = ValidationModel(null, null, isValidate: false).obs;
  ...
  getGuestUser() async {
    ...
    logcat("isGuest.value", isGuest.value.toString());
    update();
  }
  ...
  void validateDeliveryName(String? val) {
    deliveryNameModel.update((model) {
      if (val == null || val.isEmpty) {
  ...
  void enablButton() {
    if (isGuest.value == true) {
      if (userNameModel.value.isValidate == false) {
        ...
        isFormInvalidate.value = false;
      } else if (deliveryNameModel.value.isValidate == false) {
        isFormInvalidate.value = false;
      ...
      if (deliveryNameModel.value.isValidate == false) {
        isFormInvalidate.value = false;
      } else if (addressLineModel.value.isValidate == false) {
        isFormInvalidate.value = false;
      } else if (streetModel.value.isValidate == false) {
