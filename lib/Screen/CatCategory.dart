            ...
            children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        gradient: LinearGradient(
                                          ...
                                          colors: [
                                            datas7[index].gradientStartColor,
                                            datas7[index].gradientEndColor,
                                          ],
                                        ),
                                        border: Border.all(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: Center(
                                                    child: Text(
                                                      data.title2,
                                                      textAlign: TextAlign.center,style: TextStyle(fontSize: 2.w),
                                                    ),
                                                  ),
                                                )
                                              ],
              ...
              Container(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: List.generate(
                      datas9.length, (index) => buildDot2(index, context)),
                ),
              ),
              SizedBox(
                height: 1.5.h,
